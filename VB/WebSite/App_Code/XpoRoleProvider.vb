...
Public NotInheritable Class XpoRoleProvider
	...
	Public Overrides Sub AddUsersToRoles(ByVal usernames() As String, ByVal roleNames() As String)
		...
		Using uow As UnitOfWork = XpoHelper.GetNewUnitOfWork()
			Dim xpcUsers As XPCollection(Of XpoUser) = New XPCollection(Of XpoUser)(uow, New GroupOperator(GroupOperatorType.And, New BinaryOperator("ApplicationName", ApplicationName, BinaryOperatorType.Equal), New InOperator("UserName", usernames)))
			Dim xpcRoles As XPCollection(Of XpoRole) = New XPCollection(Of XpoRole)(uow, New GroupOperator(GroupOperatorType.And, New BinaryOperator("ApplicationName", ApplicationName, BinaryOperatorType.Equal), New InOperator("RoleName", roleNames)))
	...
	Public Overrides Function FindUsersInRole(ByVal roleName As String, ByVal userNameToMatch As String) As String()
        ...
        Using session As Session = XpoHelper.GetNewSession()
            ...
            Dim usersList As List(Of String) = New List(Of String)()
	...
	Public Overrides Function GetAllRoles() As String()
        ...
        Using session As Session = XpoHelper.GetNewSession()
            ...
            Dim rolesList As List(Of String) = New List(Of String)()
	...
	Public Overrides Function IsUserInRole(ByVal username As String, ByVal roleName As String) As Boolean
		...
		Using session As Session = XpoHelper.GetNewSession()
			Dim collection As XPCollection(Of XpoUser) = New XPCollection(Of XpoUser)(session, New GroupOperator(GroupOperatorType.And, New CriteriaOperator() { New ContainsOperator("Roles", New BinaryOperator("RoleName", roleName)), New BinaryOperator("UserName", username, BinaryOperatorType.Equal)}))
