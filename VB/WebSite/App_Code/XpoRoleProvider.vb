...
Public NotInheritable Class XpoRoleProvider
    ...
    Public Overrides Function IsUserInRole(ByVal username As String, ByVal roleName As String) As Boolean
        ...
        Using session As Session = XpoHelper.GetNewSession()
            Dim collection As XPCollection(Of XpoUser) = New XPCollection(Of XpoUser)(session, New GroupOperator(GroupOperatorType.And, New CriteriaOperator() { _
                New ContainsOperator("Roles", New BinaryOperator("RoleName", roleName)), _
                New BinaryOperator("UserName", username, BinaryOperatorType.Equal) _
            }))
